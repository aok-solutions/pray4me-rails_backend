...
#     new_user = {user: {username: "daenerys", email: "daenerys@targaryen.com"}}
#
...
#       expect(users_response['username']).to eq("daenerys")
#       expect(users_response['email']).to eq("daenerys@targaryen.com")
#     end
#
...
#     update_username = {user: {username: "daenerys"}}
#
...
#
#   def create_username
#     Faker::GameOfThrones.unique.character.delete(" ").underscore
#   end
# end